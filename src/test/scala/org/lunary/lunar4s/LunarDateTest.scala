...
//  }
  ...
  "specific date" should "convert back" in {
    // 2018-01-01 should be 2018-02-16
//    let expected = new Date('2018-02-16')
//    let actual = (new LunarDate(new Date())).ToWesternDate(2018, 1, 1)
//    toExpect(actual, expected)
//
    // 1983-04-24 should be 1983-06-05
//    expected = new Date('1983-06-05')
//    actual = (new LunarDate(new Date())).ToWesternDate(1983, 4, 24)
//    toExpect(actual, expected)
